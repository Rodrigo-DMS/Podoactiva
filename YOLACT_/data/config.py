...
foot_pron_dataset = dataset_base.copy({
  ...
  'train_info': '/content/gdrive/MyDrive/BEP/DATA/datasetv3/train/annotations.json',
  'train_images': '/content/gdrive/MyDrive/BEP/DATA/datasetv3/train/images/',
  'valid_info': '/content/gdrive/MyDrive/BEP/DATA/datasetv3/valid/annotations.json',
  'valid_images': '/content/gdrive/MyDrive/BEP/DATA/datasetv3/valid/images/',
